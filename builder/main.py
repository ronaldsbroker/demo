...
def main():
    stars = requests.get(
        f"https://api.github.com/repos/ronaldsbroker/demo").json()["stargazers_count"]
    forks = requests.get(
        f"https://api.github.com/repos/ronaldsbroker/demo").json()["forks_count"]
    ...
    console.print(pyfiglet.figlet_format("Zone Client", font="graffiti"),
